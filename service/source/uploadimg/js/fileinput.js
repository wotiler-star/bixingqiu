...
(function (factory) {
    ...
    tFooter = '<div class="file-thumbnail-footer" width="80px">\n' +
        // '    <div class="file-footer-caption" title="{caption}" width="80px">{caption}{size}</div>\n' +
        '    {progress} {actions}\n' +
        '</div>';
    tActions = '<div class="file-actions">\n' +
        '    <div class="file-footer-buttons">\n' +
        '<span type="button" class="prev-move btn btn-xs btn-default" title="×ó" data-key="0"><i class="glyphicon glyphicon-circle-arrow-left text-danger"></i></span>' +
